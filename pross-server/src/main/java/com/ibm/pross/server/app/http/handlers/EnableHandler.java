...
/**
 * This handler re-enables a share of a secret for use in exponentiation,
...
public class EnableHandler extends AuthenticatedClientRequestHandler {

	public static final Permissions REQUEST_PERMISSION = Permissions.ENABLE;
	...
	public EnableHandler(final KeyLoader clientKeys, final AccessEnforcement accessEnforcement,
	...
	public void authenticatedClientHandle(final HttpExchange exchange, final String username)
		...
		// Create response
		final String response =  secretName + " has been ENABLED for operations.\n";
