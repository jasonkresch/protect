...
/**
 * This handler disables a share of a secret for use in exponentiation, reading,
 * signing and other operations. Client's must have a specific authorization to
 * be able to invoke this method. If the secret is not found a 404 is returned.
 * If the client is not authorized a 403 is returned.
 * </pre>
 */
...
public class DisableHandler extends AuthenticatedClientRequestHandler {
	...
	public DisableHandler(final KeyLoader clientKeys, final AccessEnforcement accessEnforcement,
	...
	public void authenticatedClientHandle(final HttpExchange exchange, final String username) throws IOException,
		...
		// Create response
		final String response = secretName + " has been DISABLED for operations.\n";
