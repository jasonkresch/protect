...
public class ZeroKnowledgeProver {
	...
	// Group Constants
	public static final EcCurve curve = DkgNewShareholder.curve;
	public static final EcPoint g = DkgNewShareholder.g;
	public static final EcPoint h = DkgNewShareholder.h;
	...
	public static void main(String[] args)
	{
		...
		final ZeroKnowledgeProof zkp = createProof(a0, b0);
		System.out.println(zkp);
		
		System.out.println("Verified proof: " + verifyProof(C0, zkp));
