...
public interface SingleExecutable extends Executable {
	 ...
	 * 
	 * The message context contains a lot of information about the request, such as
	 * timestamp, nonces and sender. The code for this method MUST use the value of
	 * timestamp instead of relying on its own local clock, and nonces instead of
	 * trying to generated its own random values.
	 * 
	 ...
	 *
	 * @param command
	 *            the command issue by the client
	 * @param msgCtx
	 *            information related with the command
	 * 
