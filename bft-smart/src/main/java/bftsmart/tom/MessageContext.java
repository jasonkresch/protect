 ...
 * It stores all informations regarding the message sent by the client, as well
 * as the consensus instance in which it was ordered.
 * 
 * @author alysson
 */
public class MessageContext implements Serializable {
	...
	/**
	 * Returns the id of the consensus in which this message was ordered (-1 if
	 * readonly).
	 * 
	...
	/**
	 * Returns the id of the leader replica in which this message was ordered (-1 if
	 * readonly).
	 * 
	...
	/**
	 * Generates a TOMMessage for its associated requests using the new info that it
	 * now supports since the previous commit. It is assumed that the byte array
	 * passed to this method is the serialized request associated to the original
	 * TOMMessage.
	 * 
	 * @param content
	 *            Serialized request associated to the original TOMMessage.
	 * @return A TOMMessage object that is equal to the original object issued by
	 *         the client
	 */
