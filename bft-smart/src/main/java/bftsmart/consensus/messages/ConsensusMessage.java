...
public class ConsensusMessage extends SystemMessage {
	 ...
	 * or PROPOSE message TODO: How about removing the modifier, to make it visible
	 * just within the package?
	 * 
	 * @param paxosType
	 *            This should be MessageFactory.COLLECT or MessageFactory.PROPOSE
	 * @param id
	 *            Consensus's ID
	 * @param epoch
	 *            Epoch timestamp
	 ...
	 * message TODO: How about removing the modifier, to make it visible just within
	 * the package?
	 * 
	 * @param type
